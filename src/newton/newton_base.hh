...
#ifndef DUNE_PDELAB_NEWTON_BASE_HH
#define DUNE_PDELAB_NEWTON_BASE_HH
    ...
    namespace PDELab
    {
        ...
        protected:
            virtual void defect(TestVector& r)
            {
                ...
                //  Dune::printvector(std::cout,r.base(),"residual ","row",10,9,1);

                //Dune::printvector(std::cout,(*this->u).base(),"vector ","row",10,9,1);
                    ...
                    if (this->verbosity_level >= 2)
                        {
                            ...
                            std::cout << "  Initial defect: "
                                      << std::setw(12) << std::setprecision(20) << std::scientific
                            ...
                            try
                                {
                                    ...
                                    //Dune::printvector(std::cout,r.base(),"residual","row",10,9,15);
                                    //Dune::printSparseMatrix(std::cout, A.base(), "matrix", "row", 10, 15);
                                    //std::cout << "matrix " << std::endl;
                                    // Dune::print_row(std::cout,A.base(),1,1,1,9,15); std::cout << std::endl;
                                    //Dune::print_row(std::cout,A.base(),2,2,2,9,15); std::cout << std::endl;
                                    //std::cout << "matrix " << std::endl;
                            ...
                            try
                                {
                                    ...
                                    //Dune::printvector(std::cout,z.base(),"solution","row",10,9,15);
